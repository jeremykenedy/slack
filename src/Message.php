...
class Message
{
     ...
     *
     * @param \jeremykenedy\Slack\Client $client
     * @return void
     */
    ...
    public function attach($attachment)
    {
        ...
        throw new InvalidArgumentException('Attachment must be an instance of jeremykenedy\\Slack\\Attachment or a keyed array');
    }
