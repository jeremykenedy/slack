...
class ClientUnitTest extends PHPUnit_Framework_TestCase
{
    public function testInstantiationWithNoDefaults()
    {
        ...
        $this->assertInstanceOf('jeremykenedy\Slack\Client', $client);
    ...
    public function testCreateMessage()
    {
        ...
        $this->assertInstanceOf('jeremykenedy\Slack\Message', $message);
    ...
    public function testWildcardCallToMessage()
    {
        ...
        $message = $client->to('@jeremykenedy');

        $this->assertInstanceOf('jeremykenedy\Slack\Message', $message);

        $this->assertSame('@jeremykenedy', $message->getChannel());
    }
}
