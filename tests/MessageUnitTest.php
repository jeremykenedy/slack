...
class MessageUnitTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('jeremykenedy\Slack\Message', $this->getMessage());
    }
    ...
    public function testSetUsernameWithFrom()
    {
        ...
        $message->from('Developernator');

        $this->assertSame('Developernator', $message->getUsername());
    }
    ...
    public function testSetUsernameWithSetter()
    {
        ...
        $message->setUsername('Developernator');
    ...
    {
        return new Message(Mockery::mock('jeremykenedy\Slack\Client'));
    }
}
